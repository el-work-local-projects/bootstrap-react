...
class Forms extends React.Component {
	...
	updateSelectionState(field, e) {
		let selec = this.state.selected;
		selec[field] = e.currentTarget.value;
		this.setState({selected: selec});
	}
	
	updateMultiselect(e) {
		let selec = this.state.selected;
		selec.multiselect = Array.from(e.currentTarget.selectedOptions, option => option.value);
		this.setState({selected: selec});
	}
			...
			<div class="row">
				<div class="col">
							...
							<form>
								<fieldset>
									<div class="form-group">
										<label for="focusedInput">Default</label>
										<input class="form-control" id="focusedInput" type="text" value="Click me"/>
									</div>
									<div class="form-group">
										<label for="disabledInput">Disabled</label>
										<input class="form-control" id="disabledInput" type="text" value="Disabled input..." disabled/>
									</div>
									<div class="form-group">
										<label for="disabledInput">Read only</label>
									...
									<div class="form-group">
										...
										<input class="form-control-plaintext" type="text" value="Plaintext input"/>
									</div>
								</fieldset>
							</form>
						</div>
					...
					<div class="row">
						<div class="col-2">
							<label>Text</label>
							<small class="form-text text-muted">Requires additional pylons</small>
						</div>
						<div class="col-sm-2">
							<form>
								<fieldset>
						...
						<div class="col-sm-2">
							<form>
								<fieldset>
									<div class="form-group">
										<label>Select</label>
										<select class="form-control" value={this.state.selected.select} 
												onChange={e => this.updateSelectionState('select', e)}>
											<option></option>
										...
										<select class="custom-select" value={this.state.selected.select} 
												onChange={e => this.updateSelectionState('select', e)}>
											<option></option>
										{this.state.options.map((opt) => (
											<option key={opt}>{opt}</option>
							...
							<form>
								<fieldset>
									<div class="form-group">
										...
										<select class="form-control" value={this.state.selected.multiselect} multiple
